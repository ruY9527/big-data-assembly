...
public class WindowJoinByExp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        stream1.join(stream2).where(r -> r.f0).equalTo(r -> r.f0)
                .window(TumblingEventTimeWindows.of(Time.seconds(5)))
                .apply(new JoinFunction<Tuple2<String, Long>, Tuple2<String, Long>, Object>() {
                    @Override
                    public Object join(Tuple2<String, Long> first, Tuple2<String, Long> second) throws Exception {
                        return first + "=>" + second;
                    }
                }).print();
